...
export default function ArticleCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
    >
      <div className="flex h-full flex-col gap-2 rounded-2xl border border-brand-navy/10 bg-white p-6 shadow-sm transition-shadow duration-300 hover:shadow-xl hover:shadow-brand-blue/15">
