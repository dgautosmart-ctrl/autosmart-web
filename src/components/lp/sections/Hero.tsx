  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-4 text-center sm:px-8">
        ...
        <p
          className="stage mt-4 whitespace-nowrap text-[clamp(0.82rem,3.7vw,1.6rem)] font-extrabold tracking-tight text-[#8fe3f0] [text-shadow:0_0_26px_rgba(110,201,232,0.5)]"
          style={s("0.95s")}
        >
